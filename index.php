...
if(file_exists(ABSPATH.'wp-content/plugins/sp-rental-manager/premium/index.php')){
  include(ABSPATH.'wp-content/plugins/sp-rental-manager/premium/index.php');
  $rm_pre_ver =  'Premium version';
}else{
